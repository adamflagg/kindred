...
| Returning / First-time                                                                    | bottom-right                      | prior Family Camp attendance   | a **16px icon**, no text label. Returning is `green-700`/`green-300` — the semantic ramp, not `forest`, which measured 1.08 : 1 against the card's own text (§5b)                                     | R3 · 2026-08-20 |
