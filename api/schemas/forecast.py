...
class SessionForecast(BaseModel):
    ...
    enrolled_boys: int | None = Field(None, description="Enrolled male count (from snapshot)")
    enrolled_girls: int | None = Field(None, description="Enrolled female count (from snapshot)")
