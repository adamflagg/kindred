...
func TestUpsertAdultsUpdateDetection(t *testing.T) {
	...
	newAdults := []*testAdult{
		{HouseholdCMID: 100, AdultNumber: 1, FirstName: "John", LastName: "Smith", Email: "john.smith@newdomain.com"}, // Changed
		{HouseholdCMID: 100, AdultNumber: 2, FirstName: "Jane", LastName: "Smith", Email: "jane@example.com"},         // Unchanged
	}
...
func TestUpsertAdultsOrphanDeletion(t *testing.T) {
	...
	existingAdults := []*testAdult{
		{HouseholdCMID: 100, AdultNumber: 1, FirstName: "John", LastName: "Smith", Email: "john@example.com"},
		{HouseholdCMID: 100, AdultNumber: 2, FirstName: "Jane", LastName: "Smith", Email: "jane@example.com"},
		{HouseholdCMID: 200, AdultNumber: 1, FirstName: "Bob", LastName: "Jones", Email: "bob@example.com"}, // Will be orphaned
	}
	existing := buildExistingAdultsMap(existingAdults, 2025)
...
func buildAdultCompositeKey(householdPBID string, year int, adultNumber int) string {
...
func simulateUpsertAdultsWithTracking(adults []*testAdult, existing map[string]*testAdultRecord, year int, processedKeys map[string]bool) testUpsertStats {
	stats := testUpsertStats{}
...
func simulateUpsertRegistrations(regs []*testRegistration, existing map[string]*testRegRecord, year int) testUpsertStats {
	stats := testUpsertStats{}
