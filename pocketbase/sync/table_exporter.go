...
var SyncJobToCollections = map[string][]string{
	...
	"quest_registrations":        {"quest_registrations"},
...
func GetReadableYearExports() []ExportConfig {
	return []ExportConfig{
		...
		// Camper History - denormalized camper data with retention metrics (v2: one row per person/session/year)
		{
			...
			Columns: []ColumnConfig{
				...
				{Field: "session_cm_id", Header: "Session CM ID", Type: FieldTypeNumber},
				{Field: "session_name", Header: "Session", Type: FieldTypeText},
				{Field: "session_type", Header: "Session Type", Type: FieldTypeText},
				{Field: "bunk_name", Header: "Bunk", Type: FieldTypeText},
		...
		// Financial Aid Applications - derived table extracting FA- fields from person_custom_values
		{
			Collection: "financial_aid_applications",
			SheetName:  "FA Applications",
			IsGlobal:   false,
			Columns: []ColumnConfig{
				{Field: "person_id", Header: "Person ID", Type: FieldTypeNumber},
				{
				...
				{Field: "camper_name", Header: "Camper Name", Type: FieldTypeText},
				{Field: "interest_expressed", Header: "Interest", Type: FieldTypeBool},
				{Field: "contact_first_name", Header: "Contact First", Type: FieldTypeText},
				{Field: "contact_last_name", Header: "Contact Last", Type: FieldTypeText},
				{Field: "contact_email", Header: "Contact Email", Type: FieldTypeText},
				{Field: "contact_city", Header: "City", Type: FieldTypeText},
				{Field: "contact_state", Header: "State", Type: FieldTypeText},
				{Field: "summer_program", Header: "Summer Program", Type: FieldTypeText},
				{Field: "summer_amount_requested", Header: "Summer Amt Req", Type: FieldTypeNumber},
				{Field: "fc_program", Header: "FC Program", Type: FieldTypeText},
				...
				{Field: "applicant_signature", Header: "Signature", Type: FieldTypeText},
			},
		},
