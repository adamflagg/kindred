...
migrate((app) => {
  ...
  const openReadOnly = ["persons", "attendees", "attendee_status_history", "camp_sessions", "divisions", "config"]
  ...
  const anyRoleReadOnly = ["persons", "attendees", "attendee_status_history", "camp_sessions", "divisions", "config"]
