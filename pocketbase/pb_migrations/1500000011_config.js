...
migrate((app) => {
  ...
  const SECTION_MAPPING = {
    ...
    'ai.historical_context.enabled': 'history-tracking',
    'ai.historical_context.years_to_check': 'history-tracking',
    'ai.historical_context.auto_decline_not_attending': 'history-tracking',
    'ai.historical_context.priority_boost_sole_request': 'history-tracking',
    'ai.history_tracking.enabled': 'history-tracking',
    'ai.history_tracking.retention_days': 'history-tracking',
    'ai.history_tracking.include_grade_changes': 'history-tracking',
