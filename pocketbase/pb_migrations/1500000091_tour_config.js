  ...
  (app) => {
    ...
    if (!existingConfig) {
      ...
      record.set("metadata", {
        ...
        tooltip: "How many days before the shared analytics intro steps are re-shown when a user clicks 'Tour This Page'. Lower values refresh knowledge more often.",
        data_type: "integer",
