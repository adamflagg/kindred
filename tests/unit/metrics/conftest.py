...
def _seed_data(conn: sqlite3.Connection) -> None:
    ...
    conn.executemany(
        ...
        [
            ...
            ("att_1", 1001, 2025, "enrolled", 2, 1, "2025-01-15", "ses_s1", "per_emma"),
            # Liam enrolled in Session 1
            ("att_2", 1002, 2025, "enrolled", 2, 1, "2025-01-20", "ses_s1", "per_liam"),
            # Olivia enrolled in Session 2
            ("att_3", 1003, 2025, "enrolled", 2, 1, "2025-02-01", "ses_s2", "per_olivia"),
            # Emma waitlisted in Session 2
            ("att_4", 1001, 2025, "waitlisted", 3, 1, "2025-02-15", "ses_s2", "per_emma"),
            # Liam cancelled from Session 2
            ("att_5", 1002, 2025, "cancelled", 5, 0, "2025-03-01", "ses_s2", "per_liam"),
        ],
    )
    ...
    conn.executemany(
        "INSERT INTO attendees VALUES (?,?,?,?,?,?,?,?,?)",
        [
            ("att_h1", 1001, 2024, "enrolled", 2, 1, "2024-01-10", "ses_s1_24", "per_emma_24"),
            ("att_h2", 1002, 2024, "enrolled", 2, 1, "2024-01-12", "ses_s2_24", "per_liam_24"),
        ],
    )
