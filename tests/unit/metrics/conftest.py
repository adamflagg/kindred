...
def _seed_data(conn: sqlite3.Connection) -> None:
    ...
    conn.executemany(
        ...
        [
            ("per_emma", 1001, "Emma", "Johnson", "F", 5, "Riverside Elementary",
             "Riverside Elementary", "San Francisco", "San Francisco",
             "Temple Beth El", 3, 2001, 2025),
            ("per_liam", 1002, "Liam", "Garcia", "M", 6, "Oak Valley Middle",
             "Oak Valley Middle", "Oakland", "Oakland",
             "Congregation Shalom", 2, 2002, 2025),
            ("per_olivia", 1003, "Olivia", "Chen", "F", 7, "Hillcrest High",
             "Hillcrest High", "San Francisco", "San Francisco",
             "", 1, 2003, 2025),
        ],
    )
    ...
    conn.executemany(
        "INSERT INTO persons VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
        [
            ("per_emma_24", 1001, "Emma", "Johnson", "F", 4, "Riverside Elementary",
             "Riverside Elementary", "San Francisco", "San Francisco",
             "Temple Beth El", 2, 2001, 2024),
            ("per_liam_24", 1002, "Liam", "Garcia", "M", 5, "Oak Valley Middle",
             "Oak Valley Middle", "Oakland", "Oakland",
             "Congregation Shalom", 1, 2002, 2024),
        ],
    )
    ...
    conn.executemany(
        ...
        [
            ("ses_s1", 1000001, "Session 1", "main", None,
             "2025-06-15", "2025-07-12", 2025),
            ("ses_s2", 1000002, "Session 2", "main", None,
             "2025-07-13", "2025-08-09", 2025),
            ("ses_ag1", 1000003, "AG Session 1", "ag", 1000001,
             "2025-06-15", "2025-07-12", 2025),
            ("ses_q", 1000004, "Quest Adventure", "quest", None,
             "2025-07-01", "2025-07-07", 2025),
        ],
    )
    ...
    conn.executemany(
        "INSERT INTO camp_sessions VALUES (?,?,?,?,?,?,?,?)",
        [
            ("ses_s1_24", 1000001, "Session 1", "main", None,
             "2024-06-15", "2024-07-12", 2024),
            ("ses_s2_24", 1000002, "Session 2", "main", None,
             "2024-07-13", "2024-08-09", 2024),
        ],
    )
    ...
    conn.executemany(
        ...
        [
            ...
            ("att_1", 1001, 2025, "enrolled", 2, 1, "2025-01-15",
             "ses_s1", "per_emma"),
            # Liam enrolled in Session 1
            ("att_2", 1002, 2025, "enrolled", 2, 1, "2025-01-20",
             "ses_s1", "per_liam"),
            # Olivia enrolled in Session 2
            ("att_3", 1003, 2025, "enrolled", 2, 1, "2025-02-01",
             "ses_s2", "per_olivia"),
            # Emma waitlisted in Session 2
            ("att_4", 1001, 2025, "waitlisted", 3, 1, "2025-02-15",
             "ses_s2", "per_emma"),
            # Liam cancelled from Session 2
            ("att_5", 1002, 2025, "cancelled", 5, 0, "2025-03-01",
             "ses_s2", "per_liam"),
        ],
    )
    ...
    conn.executemany(
        "INSERT INTO attendees VALUES (?,?,?,?,?,?,?,?,?)",
        [
            ("att_h1", 1001, 2024, "enrolled", 2, 1, "2024-01-10",
             "ses_s1_24", "per_emma_24"),
            ("att_h2", 1002, 2024, "enrolled", 2, 1, "2024-01-12",
             "ses_s2_24", "per_liam_24"),
        ],
    )
    ...
    conn.executemany(
        ...
        [
            ...
            ("cfg_bud1", "budget", "2025", "session_1000001",
             json.dumps({"participant_goal": 150, "session_fee": 5000})),
            ("cfg_bud2", "budget", "2025", "session_1000002",
    ...
    conn.executemany(
        ...
        [
            ("ash_1", 1001, 2025, "waitlisted", "enrolled", "2025-02-20",
             "ses_s2", "per_emma"),
            ("ash_2", 1002, 2025, "enrolled", "cancelled", "2025-03-01",
             "ses_s1", "per_liam"),
        ],
    )
    ...
    conn.executemany(
        """INSERT INTO enrollment_snapshots VALUES
           (?,?,?,?,?,?,?,?,?,?,?,?,?)""",
        [
            ("snap_1", 2025, 1000001, "2025-01-15",
             50, 5, 2, 25, 25, 3, 2, 1, 1),
            ("snap_2", 2025, 1000001, "2025-02-15",
             100, 10, 5, 52, 48, 6, 4, 3, 2),
            ("snap_3", 2025, 1000002, "2025-01-15",
             30, 3, 1, 15, 15, 2, 1, 0, 1),
        ],
    )
