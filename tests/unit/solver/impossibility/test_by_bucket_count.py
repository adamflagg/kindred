...
def test_by_bucket_count_dedupes_multi_reason_request(mock_config):
    ...
    req = make_request("r1", requester=1, requestee=2, source_field="bunk_request_form", session=100)
...
def test_by_bucket_count_excludes_bucket_none_items(mock_config):
    ...
    req1 = make_request("r1", requester=1, requestee=2, source_field="bunk_request_form")
