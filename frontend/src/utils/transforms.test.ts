...
const createMockPerson = (
  overrides: Partial<PersonsResponse> = {},
): PersonsResponse =>
  ({
    id: "person-1",
    cm_id: 12345,
...
const createMockAttendee = (
  overrides: Partial<AttendeesResponse> = {},
): AttendeesResponse =>
  ({
    id: "attendee-1",
    person: "person-1",
...
const createMockBunk = (
  overrides: Partial<BunksResponse> = {},
): BunksResponse =>
  ({
    id: "bunk-1",
    cm_id: 100,
...
const createMockSession = (
  overrides: Partial<CampSessionsResponse> = {},
): CampSessionsResponse =>
  ({
    id: "session-1",
    cm_id: 1001,
...
describe("createLookupMaps", () => {
  ...
  it("should skip assignments without expanded person", () => {
    const assignments = [createMockAssignment({ id: "a1" })] as Array<
      BunkAssignmentsResponse<{ person?: PersonsResponse }>
    >;
...
describe("buildCampersFromData", () => {
  ...
  it("should include bunk from assignment map", () => {
    ...
    const assignments = new Map<
      number,
      BunkAssignmentsResponse<{ bunk?: BunksResponse }>
    >([[12345, assignment]]);
