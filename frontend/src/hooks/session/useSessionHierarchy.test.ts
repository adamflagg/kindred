...
describe("getSubSessions", () => {
  ...
  it("should find embedded sessions by parent_id relationship", () => {
    ...
    const embeddedA = createMockSession(
      "s2",
      "Session 2a",
      1002,
      "embedded",
    ...
    const embeddedB = createMockSession(
      "s3",
      "Session 2b",
      1003,
      "embedded",
...
describe("getAgSessions", () => {
  ...
  it("should find AG sessions by parent_id and session_type", () => {
    ...
    const agSession = createMockSession(
      "s2",
      "Session 1 All-Gender",
      1002,
      "ag",
      1001,
    );
  ...
  it("should filter out AG sessions with zero bunk plans", () => {
    const parentSession = createMockSession("s1", "Session 1", 1001, "main");
    const agSession1 = createMockSession(
      "s2",
      "Session 1 AG",
      1002,
      "ag",
    ...
    const agSession2 = createMockSession(
      "s3",
      "Session 1 AG Extra",
      1003,
      "ag",
