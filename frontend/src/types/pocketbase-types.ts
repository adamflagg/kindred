...
export type AttendeesResponse<Texpand = unknown> = Required<AttendeesRecord> &
  BaseSystemFields<Texpand>;
export type BunkAssignmentsResponse<Texpand = unknown> =
  Required<BunkAssignmentsRecord> & BaseSystemFields<Texpand>;
export type BunkAssignmentsDraftResponse<Texpand = unknown> =
  Required<BunkAssignmentsDraftRecord> & BaseSystemFields<Texpand>;
...
> &
  BaseSystemFields<Texpand>;
export type BunksResponse<Texpand = unknown> = Required<BunksRecord> &
  BaseSystemFields<Texpand>;
export type CampSessionsResponse<Texpand = unknown> =
  Required<CampSessionsRecord> & BaseSystemFields<Texpand>;
export type ConfigResponse<
  Tmetadata = unknown,
  Tvalue = unknown,
  Texpand = unknown,
> = Required<ConfigRecord<Tmetadata, Tvalue>> & BaseSystemFields<Texpand>;
export type ConfigSectionsResponse<Texpand = unknown> =
  Required<ConfigSectionsRecord> & BaseSystemFields<Texpand>;
export type LockedGroupMembersResponse<Texpand = unknown> =
  Required<LockedGroupMembersRecord> & BaseSystemFields<Texpand>;
export type LockedGroupsResponse<Texpand = unknown> =
  Required<LockedGroupsRecord> & BaseSystemFields<Texpand>;
export type OriginalBunkRequestsResponse<Texpand = unknown> =
  Required<OriginalBunkRequestsRecord> & BaseSystemFields<Texpand>;
export type PersonsResponse<
  ...
  Texpand = unknown,
> = Required<
  PersonsRecord<Taddress, Temail_addresses, Tphone_numbers, Traw_data>
> &
  BaseSystemFields<Texpand>;
export type SavedScenariosResponse<
  Tmetadata = unknown,
  Texpand = unknown,
> = Required<SavedScenariosRecord<Tmetadata>> & BaseSystemFields<Texpand>;
...
export type TypedPocketBase = PocketBase & {
  ...
  collection(
    idOrName: "bunk_assignments",
  ): RecordService<BunkAssignmentsResponse>;
  collection(
    idOrName: "bunk_assignments_draft",
  ): RecordService<BunkAssignmentsDraftResponse>;
  ...
  collection(
    idOrName: "config_sections",
  ): RecordService<ConfigSectionsResponse>;
  collection(
    idOrName: "locked_group_members",
  ): RecordService<LockedGroupMembersResponse>;
  collection(idOrName: "locked_groups"): RecordService<LockedGroupsResponse>;
  collection(
    idOrName: "original_bunk_requests",
  ): RecordService<OriginalBunkRequestsResponse>;
  collection(idOrName: "persons"): RecordService<PersonsResponse>;
  collection(
    idOrName: "saved_scenarios",
  ): RecordService<SavedScenariosResponse>;
