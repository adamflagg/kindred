...
export default function RetentionOverview() {
  ...
  const summerYearsChartData = transformRetentionSummerYearsData(
    detailedData?.by_summer_years,
  );
  ...
  const schoolTableData = transformDemographicTableData(
    detailedData?.by_school,
    "school",
  );
  const cityTableData = transformDemographicTableData(
    detailedData?.by_city,
    "city",
  );
  const synagogueTableData = transformDemographicTableData(
    detailedData?.by_synagogue,
    "synagogue",
  );
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {trendsData.enrollment_by_year &&
          trendsData.enrollment_by_year.length > 0 && (
            <GenderStackedChart
      ...
      {(schoolTableData.length > 0 ||
        ...
        <div className="mt-8">
          ...
          <p className="text-sm text-muted-foreground mb-4">
            Full demographic data for data quality review. Search and sort to
            find patterns.
          </p>
