        ...
        <CurrentYearContext.Provider value={mockYearContext}>
          <Routes>
            <Route path="/metrics/*" element={<MetricsLayout />}>
              <Route
                path="registration/*"
                element={<TestChild text={childText} />}
              />
              <Route
                path="retention"
                element={<TestChild text="Retention" />}
              />
...
describe("MetricsLayout", () => {
  it("renders primary navigation tabs", () => {
    ...
    expect(
      screen.getByRole("link", { name: /retention/i }),
    ).toBeInTheDocument();
  ...
  it("renders sub-nav for registration routes", () => {
    ...
    expect(
      screen.getByRole("link", { name: /geographic/i }),
    ).toBeInTheDocument();
    expect(
      screen.getByRole("link", { name: /synagogue/i }),
    ).toBeInTheDocument();
  ...
  it("does not render sub-nav for retention routes", () => {
    ...
    expect(
      screen.queryByRole("link", { name: /geographic/i }),
    ).not.toBeInTheDocument();
  });
