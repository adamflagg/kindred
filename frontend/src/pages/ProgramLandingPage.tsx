...
export default function ProgramLandingPage() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      {/* Decorative elements */}
      <div
        className="absolute top-20 left-10 text-primary/5 animate-float"
        style={{ animationDelay: "0s" }}
      >
        <Trees className="w-24 h-24" />
      </div>
      <div
        className="absolute top-40 right-16 text-accent/10 animate-float"
        style={{ animationDelay: "1s" }}
      >
        <Sun className="w-16 h-16" />
      </div>
      <div
        className="absolute bottom-32 left-1/4 text-primary/5 animate-float"
