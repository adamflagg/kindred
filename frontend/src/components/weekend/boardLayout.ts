...
/**
 * How many SPOTS a party consumes.
 *
 * Spots, not bodies, since #1925 and #2046: the server drops blank and
 ...
 * it — `slotOccupancy`, `partySpots` and `spotsNeeded` all want spots, and
 * the card's own names-chip is #2152's to split out.
 *
 ...
 * shared. The reported `party_size` is a SPOT count and must survive: since
 ...
 * only child is an infant reports zero spots. Recounting the bodies there
 ...
 * with nothing reported the spots number and the headcount coincide — that
