...
describe('MapUnitPopover — a cluster of rooms', () => {
  ...
  it('announces an empty room as empty without relying on aria-label', () => {
    ...
    // "Cedar 1 — empty".
    const cell = screen.getAllByTestId('map-popover-cell')[0] as HTMLElement
    expect(cell).toHaveAttribute('title', expect.stringContaining('Cedar 1'))
    // The VISIBLE label stays short, which is the whole point of the strip.
    expect(cell).toHaveTextContent('1')
    expect(cell).not.toHaveTextContent('Cedar 1')
  })
