/**
 * RetentionSessionSelector - Session dropdown for retention tab
 *
 * Allows filtering retention metrics to a specific session.
...
export interface RetentionSessionSelectorProps {
...
export function RetentionSessionSelector({
  sessions,
  selectedSessionCmId,
  onSessionChange,
  isLoading = false,
}: RetentionSessionSelectorProps) {
