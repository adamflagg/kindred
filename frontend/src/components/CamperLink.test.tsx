...
describe('CamperLink', () => {
  ...
  describe('when personCmId is invalid', () => {
    it('renders as plain text when personCmId is null', () => {
      renderWithRouter(
        <CamperLink personCmId={null} displayName="Unknown Person" isConfirmed={true} />
      )
    ...
    it('renders as plain text when personCmId is negative (placeholder)', () => {
      renderWithRouter(
        <CamperLink personCmId={-707171137} displayName="Ella Lanford" isConfirmed={true} />
      )
    ...
    it('renders as plain text when personCmId is zero', () => {
      renderWithRouter(<CamperLink personCmId={0} displayName="Some Person" isConfirmed={true} />)
    ...
    it('renders as plain text when personCmId is undefined', () => {
      renderWithRouter(
        <CamperLink personCmId={undefined} displayName="Some Person" isConfirmed={true} />
      )
  ...
  describe('display fallback', () => {
    it('shows fallback text when displayName is empty and personCmId is valid', () => {
      renderWithRouter(<CamperLink personCmId={12345} displayName="" isConfirmed={true} />)
    ...
    it('shows nothing meaningful when both displayName and personCmId are invalid', () => {
      renderWithRouter(<CamperLink personCmId={null} displayName="" isConfirmed={false} />)
