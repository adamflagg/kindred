    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-4 gap-4">
        <div className="bg-card rounded-lg border p-4">
          ...
          <div className="text-muted-foreground text-sm">Total Groups</div>
        </div>
        <div className="bg-card rounded-lg border p-4">
          <div className="text-2xl font-bold text-green-600">{stats.complete}</div>
          <div className="text-muted-foreground text-sm">Complete Groups</div>
        </div>
        <div className="bg-card rounded-lg border p-4">
          <div className="text-2xl font-bold text-yellow-600">{stats.split}</div>
          <div className="text-muted-foreground text-sm">Split Groups</div>
        </div>
        <div className="bg-card rounded-lg border p-4">
          <div className="text-muted-foreground text-2xl font-bold">{stats.isolated}</div>
          <div className="text-muted-foreground text-sm">Isolated Campers</div>
        </div>
      </div>
