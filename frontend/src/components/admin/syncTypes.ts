...
export const CURRENT_YEAR_SYNC_TYPES = [
  ...
  { id: 'persons', name: 'Persons', icon: User, color: 'text-violet-600' }, // Combined: persons + households + person_tags
...
// Note: "persons" sync also populates households and person_tags tables
export const HISTORICAL_SYNC_TYPES = [
  { id: 'session_groups', name: 'Session Groups' },
  { id: 'sessions', name: 'Sessions' },
  { id: 'attendees', name: 'Attendees' },
  { id: 'persons', name: 'Persons' }, // Combined: persons + households + person_tags
  { id: 'bunks', name: 'Bunks' },
