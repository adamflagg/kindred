...
export const YEAR_SYNC_TYPES = [
  ...
  // kindred#2759: the adult-weekend Jotform pull. Runs on the daily cron now, gated on
  // JOTFORM_API_KEY being configured -- this card's Run button still starts it on demand.
  {
