...
export function ScaleGuideSidebar({ activeCategory }: ScaleGuideSidebarProps) {
  ...
  const tabLabel =
    activeCategory === "solver" ? "Bunk Optimizer" : "Processing";
        ...
        <div className="relative h-full overflow-y-auto">
          ...
          <div className="sticky bottom-0 bg-gradient-to-t from-stone-100 dark:from-stone-900 to-transparent px-4 py-4">
            <p className="text-sm text-muted-foreground text-center leading-relaxed">
              Hover{" "}
              <span className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-stone-300 dark:bg-stone-600 text-xs font-bold align-middle mx-0.5">
                ?
              </span>{" "}
              icons for details
            </p>
